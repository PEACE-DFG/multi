...
function Navbar() {
  return (
    <div>
          {/* <!-- Topbar Start --> */}
    <div class="container-fluid" style={{ backgroundColor:'rgb(254,216,177)' }}>
        <div class="row bg-light text-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-secondary mr-3 " href="">About</a>
                    <a class="text-secondary mr-3" href="">Contact</a>
                    <a class="text-secondary  mr-3" href="">Help</a>
                    <a class="text-secondary mr-3" href="">FAQs</a>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <button class="dropdown-item" type="button"><Link to='/login'>Sign in</Link></button>
                        <button class="dropdown-item" type="button"><Link to='register'>Sign up</Link></button>
                        </ul>           
                    </div>
                ...
                <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="" class="nav-item nav-link active"><Link to='/'>Home</Link></a>
                            <a href="" class="nav-item nav-link">Shop</a>
                            <a href="" class="nav-item nav-link">Shop Detail</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-warning text-light rounded-0 border-0 m-0">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0">
                                ...
                                <span class="badge text-warning border border-secondary rounded-circle" style={{ paddingBottom:'2px' }}>0</span>
                            </a>
